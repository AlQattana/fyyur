"""Changed tables names to lowercase

Revision ID: 9be968f7af3d
Revises: a4a1a7167065
Create Date: 2021-06-22 03:05:35.080794
...
revision = '9be968f7af3d'
down_revision = 'a4a1a7167065'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('genres', postgresql.ARRAY(sa.VARCHAR(length=30)), autoincrement=False, nullable=True),
